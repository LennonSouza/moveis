...
const moveis = [
  ...
  { id: 31, nome: "Armario de produtos", tempoUso: "1 ano", precoNovo: 290, precoVenda: 210, foto: "armario-limpeza.png", icone: "ti-air-conditioning", descricao: "Armario para produtos de limpeza." },
  { id: 32, nome: "Cafeteira philco", tempoUso: "Nova", precoNovo: 210, precoVenda: 160, foto: "cafeteira.png", icone: "ti-air-conditioning", descricao: "Cafeteira na caixa, nunca usada." },
  { id: 33, nome: "Ar-Condicionado Portatil", tempoUso: "3 anos", precoNovo: 2400, precoVenda: 1500, foto: "ar-portatil.png", icone: "ti-air-conditioning", descricao: "Ar-condicionado portatil 11000 btus Britania." },
  { id: 34, nome: "Maquina Lava e Seca 11kg", tempoUso: "3 anos", precoNovo: 3400, precoVenda: 2500, foto: "lava-seca.png", icone: "ti-air-conditioning", descricao: "Maquina Lava e Seca Midea 11kg." },
  { id: 35, nome: "Frezzer Midea 205L", tempoUso: "3 anos", precoNovo: 2000, precoVenda: 1550, foto: "frezzer.png", icone: "ti-air-conditioning", descricao: "Frezzer Midea 205L." }
];
...
function criarCard(movel) {
  ...
  const imgHTML = movel.foto
    ? `<img
        src="img/${movel.foto}"
        alt="${movel.nome}"
        class="card-img-foto card-img-clicavel"
        data-lightbox-src="img/${movel.foto}"
        data-lightbox-alt="${movel.nome}"
        role="button"
        tabindex="0"
